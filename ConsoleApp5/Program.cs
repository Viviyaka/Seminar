namespace ConsoleApp5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("student s nejnižším ID: " + min.Value);

            // Vložte vlastního studenta s ID > 100 (je potřeba vytvořit nový objekt typu Student) a zkuste ho pak najít

            Student NewStudent = new Student(109, "Petr", "Novák", 20, "5.C");
            tree.Insert(NewStudent.Id, NewStudent);

            Node<Student> Peta = tree.Search(150);
            Console.WriteLine("novy student: " + Peta.Value);
